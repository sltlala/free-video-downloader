    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6">
      <div class="bg-white rounded-2xl border border-border shadow-lg overflow-hidden">
        ...
        <div class="flex flex-col sm:flex-row gap-5 p-5 sm:p-6">
          <div class="relative flex-shrink-0 w-full sm:w-72 aspect-video rounded-xl overflow-hidden bg-gray-100">
            <img
        ...
        <div class="border-t border-border-light px-5 sm:px-6 py-5">
          ...
          <div class="mt-6 flex flex-col sm:flex-row items-center gap-3">
            <button
              ...
              class="w-full sm:w-auto inline-flex items-center justify-center gap-2 h-12 px-10 rounded-full bg-primary hover:bg-primary-dark text-white font-medium text-base transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-md hover:shadow-lg cursor-pointer"
            >
            ...
            <span v-if="selectedFormat" class="text-xs text-text-muted">
